$(document).ready(function(){
	...
	switch(act){
		...
		break;
		case "13":
			// transfert table to shema (no longer available)
			ini();
			setfield("strtable","table","");
		break;
		case "14":
		...
		break;
		case "17":
			// 	move a column match one to many
			ini();
		...
		case "24":
			ini();
			$("#msg").text("Copy text to column by matching condition.");
		...
		case "32":
			ini();
			$("#msg").text("Save as a .json file");
			setfield("strtable","table","");
			setfield("value","append"," : Default is FALSE. Write TRUE is you want to append.",false);
		break;
		case "33":
			ini();
			$("#msg").text("Save as a .js file");
			setfield("strtable","table","");
			setfield("value","append"," : Default is FALSE. Write TRUE is you want to append.",false);
		break;
		case "34":
			ini();
			$("#msg").text("Switch column");
			setfield("strtable","table","");
			setfield("strfield","column A"," : This column to be switch");
			setfield("tofield","column B"," : This column will be switch");
		break;
		default:
			ini();
		}
